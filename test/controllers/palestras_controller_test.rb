...
class PalestrasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create palestra" do
    assert_difference("Palestra.count") do
      post palestras_url, params: { palestra: { nome: @palestra.nome, tempo: @palestra.tempo } }
    end
  ...
  test "should update palestra" do
    patch palestra_url(@palestra), params: { palestra: { nome: @palestra.nome, tempo: @palestra.tempo } }
